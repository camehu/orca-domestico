...
// src/config/monist.js
var monist_exports = {};
__export(monist_exports, {
  default: () => monist_default
});
module.exports = __toCommonJS(monist_exports);
var import_debug = __toESM(require_src(), 1);
var import_mongoist = __toESM(require("mongoist"), 1);
var import_config = __toESM(require("config"), 1);
var log = (0, import_debug.default)("Projeto base:config:mongoist");
var db = (0, import_mongoist.default)(import_config.default.get(mongo.uri));
db.on("error", (err) => log("mongodb err", err));
var monist_default = db;
